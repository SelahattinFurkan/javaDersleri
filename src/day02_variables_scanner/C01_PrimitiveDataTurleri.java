...
public class C01_PrimitiveDataTurleri {
    ...
    public static void main(String[] args) {
        ...
        byte byt = 10 ; // bu hafiza da 8 bit yer kapliyor
        short sh = 10 ; // bu hafiza da 16 bit yer kapliyor
        int sayi = 10 ; // bu hafiza da 32 bit yer kapliyor
        long lng = 10 ; // bu hafiza da 64 bit yer kapliyor
